...
useEffect(() => {
    const container = document.getElementById('hearContainer3');
    const bigHeart = document.getElementById('bigHeart3');
    const shadow = document.getElementById('shadow3'); 
...
<div id='hearContainer3'>
  <div id='shadow3'></div>
  <img id='bigHeart3' src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/183204/heart_(1).png" alt="heart1" height="90%" width="90%" />
  </div> 
        </div>
    )
}
