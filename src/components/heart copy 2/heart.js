...
useEffect(() => {
    const container = document.getElementById('hearContainer2');
    const bigHeart = document.getElementById('bigHeart2');
...
<div id='hearContainer2'>
  <div id='shadow2'></div>
  <img id='bigHeart2' src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/183204/heart_(1).png" alt="heart1" height="90%" width="90%" />
  </div> 
        </div>
    )
}
